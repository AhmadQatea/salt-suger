...
>
    ...
    <div class="product-sheet absolute inset-x-0 bottom-0 flex max-h-[90dvh] w-full flex-col overflow-hidden rounded-t-2xl bg-surface shadow-2xl md:inset-auto md:top-1/2 md:left-1/2 md:max-h-[min(90vh,720px)] md:w-full md:max-w-md md:-translate-x-1/2 md:-translate-y-1/2 md:rounded-2xl">
            ...
            <div class="flex flex-col gap-4 px-4 py-4 md:px-5">
                <div class="space-y-2">
                    <div class="flex items-start justify-between gap-3">
                        <h2 id="modal-product-name" class="text-xl font-bold leading-snug text-on-surface"></h2>
                        <span
                    ...
                    <p id="modal-product-price" class="text-lg font-bold text-primary"></p>
                </div>
        ...
        <div class="shrink-0 border-t border-outline-variant/30 bg-surface p-4 pb-[max(1rem,env(safe-area-inset-bottom))]">
            <button
                type="button"
                id="modal-add-to-order"
                class="ss-btn ss-btn-primary w-full py-3.5 text-sm"
            >
