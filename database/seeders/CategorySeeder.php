    ...
    public function run(): void
    {
        $categories = [
            [
                'name' => 'برغر',
                'slug' => 'burger',
                'description' => 'برغر طازج بنكهات متنوعة.',
            ...
            [
                'name' => 'وجبات',
                'slug' => 'meals',
                'description' => 'وجبات كاملة مع إضافات.',
            ...
            [
                'name' => 'ساندويش',
                'slug' => 'sandwich',
                'description' => 'ساندويشات شهية وسريعة.',
            ...
            [
                'name' => 'بيتزا',
                'slug' => 'pizza',
                'description' => 'بيتزا بعجينة طازجة.',
            ...
            [
                'name' => 'مقبلات',
                'slug' => 'appetizers',
                'description' => 'مقبلات لبداية مثالية.',
